...
function fetchData() {
    fetch('/data/itemsOrders') // Отправляем GET запрос на сервер для получения данных
...
function saveRow(row) {
    ...
    fetch('/ad/update/itemOrder', { // Используем переданный идентификатор
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json'
        },
